...
// File: src/components/projects/apple-cards-carousel.tsx
// Replace the Card component (around line 150) with this:
...
export const Card = ({
  ...
  return (
    <>
      ...
      >
        <div className="absolute inset-x-0 top-0 z-30 h-full cursor-pointer bg-gradient-to-b from-black/40 via-transparent to-transparent" />
