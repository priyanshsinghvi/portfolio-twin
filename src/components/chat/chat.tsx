...
// Simple Avatar component - Static Image
const Avatar = ({ hasActiveTool }: { hasActiveTool: boolean }) => {
  return (
    <div
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      <div className="absolute top-6 right-8 z-51 flex flex-col-reverse items-center justify-center gap-1 md:flex-row">
        ...
        <div className="">
          <GithubButton
            ...
            label="Star"
            size={'sm'}
            repoUrl="https://github.com/priyanshsinghvi"
          />
        </div>
      </div>
      ...
      <div className="container mx-auto flex h-full max-w-3xl flex-col">
        ...
        {/* Fixed Bottom Bar */}
        <div className="sticky bottom-0 px-2 pt-3 md:px-0 md:pb-4 transition-colors duration-300 bg-white dark:bg-black">
