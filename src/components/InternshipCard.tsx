...
const InternshipCard = () => {
  const openMail = () => {
    window.open('mailto:priyanshsinghvi0308@gmail.com', '_blank');
  };
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Preferably Delhi, Pune, or Hyderabad
            </p>
          </div>
        </div>
          ...
          <div className="w-full">
            ...
            <div className="text-muted-foreground grid grid-cols-1 gap-y-1 text-sm sm:grid-cols-2">
              ...
              <ul className="list-disc pl-4">
                ...
                <li>Hugging Face Transformers, n8n</li>
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          Strong foundation in AI/ML with hands-on project experience. <br />
          Expertise in automation workflows and full-stack development. <br />
          Creative problem-solving with attention to design details.
        </p>
      </div>
